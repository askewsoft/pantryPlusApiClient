...
export const ShoppersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createShopper: async (body: OmitShopperId_, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        updateShopper: async (body: OmitShopperId_, xAuthUser: string, shopperId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const ShoppersApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createShopper(body: OmitShopperId_, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Shopper>>> {
         ...
         * @throws {RequiredError}
         */
        async updateShopper(body: OmitShopperId_, xAuthUser: string, shopperId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<PickShopperId_>>> {
...
export const ShoppersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createShopper(body: OmitShopperId_, options?: AxiosRequestConfig): Promise<AxiosResponse<Shopper>> {
         ...
         * @throws {RequiredError}
         */
        async updateShopper(body: OmitShopperId_, xAuthUser: string, shopperId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<PickShopperId_>> {
...
export class ShoppersApi extends BaseAPI {
     ...
     */
    public async createShopper(body: OmitShopperId_, options?: AxiosRequestConfig) : Promise<AxiosResponse<Shopper>> {
     ...
     * @memberof ShoppersApi
     */
    public async updateShopper(body: OmitShopperId_, xAuthUser: string, shopperId: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<PickShopperId_>> {
