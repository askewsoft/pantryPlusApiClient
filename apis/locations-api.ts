...
export const LocationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getNearbyLocations: async (body: LocationArea, xAuthUser: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling getNearbyLocations.');
            }
            // verify required parameter 'xAuthUser' is not null or undefined
            if (xAuthUser === null || xAuthUser === undefined) {
                throw new RequiredError('xAuthUser','Required parameter xAuthUser was null or undefined when calling getNearbyLocations.');
            }
...
export const LocationsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getNearbyLocations(body: LocationArea, xAuthUser: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<NearbyLocation>>>> {
            const localVarAxiosArgs = await LocationsApiAxiosParamCreator(configuration).getNearbyLocations(body, xAuthUser, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const LocationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getNearbyLocations(body: LocationArea, xAuthUser: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<NearbyLocation>>> {
            return LocationsApiFp(configuration).getNearbyLocations(body, xAuthUser, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Updates an existing location name
...
export class LocationsApi extends BaseAPI {
     ...
     * @memberof LocationsApi
     */
    public async getNearbyLocations(body: LocationArea, xAuthUser: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<NearbyLocation>>> {
        return LocationsApiFp(this.configuration).getNearbyLocations(body, xAuthUser, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Updates an existing location name
