...
exports.LocationsApi = exports.LocationsApiFactory = exports.LocationsApiFp = exports.LocationsApiAxiosParamCreator = void 0;
...
exports.LocationsApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        createLocation: function (body, xAuthUser, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    if (xAuthUser === null || xAuthUser === undefined) {
                        throw new base_1.RequiredError('xAuthUser', 'Required parameter xAuthUser was null or undefined when calling createLocation.');
                    }
         ...
         * @throws {RequiredError}
         */
        updateLocation: function (body, xAuthUser, locationId, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, query, key, key, headersFromBaseOptions, needsSerialization;
                return __generator(this, function (_a) {
                    ...
                    // verify required parameter 'xAuthUser' is not null or undefined
                    if (xAuthUser === null || xAuthUser === undefined) {
                        throw new base_1.RequiredError('xAuthUser', 'Required parameter xAuthUser was null or undefined when calling updateLocation.');
                    }
    ...
    return {
        ...
        createLocation: function (body, xAuthUser, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.LocationsApiAxiosParamCreator(configuration).createLocation(body, xAuthUser, options)];
                        case 1:
        ...
        updateLocation: function (body, xAuthUser, locationId, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.LocationsApiAxiosParamCreator(configuration).updateLocation(body, xAuthUser, locationId, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
...
exports.LocationsApiFactory = function (configuration, basePath, axios) {
    return {
        ...
        createLocation: function (body, xAuthUser, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, exports.LocationsApiFp(configuration).createLocation(body, xAuthUser, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
        ...
        updateLocation: function (body, xAuthUser, locationId, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, exports.LocationsApiFp(configuration).updateLocation(body, xAuthUser, locationId, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
    };
...
var LocationsApi = /** @class */ (function (_super) {
     ...
     */
    LocationsApi.prototype.createLocation = function (body, xAuthUser, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
     ...
     * @memberof LocationsApi
     */
    LocationsApi.prototype.updateLocation = function (body, xAuthUser, locationId, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, exports.LocationsApiFp(this.configuration).updateLocation(body, xAuthUser, locationId, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    return LocationsApi;
