            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    if (xAuthUser === null || xAuthUser === undefined) {
                        throw new base_1.RequiredError('xAuthUser', 'Required parameter xAuthUser was null or undefined when calling removeItemFromCategory.');
                    }
                    // verify required parameter 'categoryId' is not null or undefined
                    if (categoryId === null || categoryId === undefined) {
                        throw new base_1.RequiredError('categoryId', 'Required parameter categoryId was null or undefined when calling removeItemFromCategory.');
                    }
                    // verify required parameter 'itemId' is not null or undefined
                    if (itemId === null || itemId === undefined) {
                        throw new base_1.RequiredError('itemId', 'Required parameter itemId was null or undefined when calling removeItemFromCategory.');
                    }
...
exports.CategoriesApiFactory = function (configuration, basePath, axios) {
    return {
        ...
        removeItemFromCategory: function (xAuthUser, categoryId, itemId, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, exports.CategoriesApiFp(configuration).removeItemFromCategory(xAuthUser, categoryId, itemId, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
