...
export declare const ShoppersApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createShopper(shopper: Shopper, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     *
     * @summary Declines an invite to a group
     * @param {string} xAuthUser the email address of the user
...
export declare class ShoppersApi extends BaseAPI {
     ...
     * @memberof ShoppersApi
     */
    createShopper(shopper: Shopper, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<void, any>>;
    /**
     *
     * @summary Declines an invite to a group
     * @param {string} xAuthUser the email address of the user
